...
const Index = () => {
  ...
  const projects = [
      {
    title: "E-commerce Website (Node.js)",
    description: "Modern e-commerce platform with Express backend, product management, and dynamic cart system.",
    technologies: ["Node.js", "Express", "MySQL", "EJS", "Bootstrap", "JavaScript"],
    features: ["User registration/login", "Product CRUD", "Shopping cart", "Image upload", "Order tracking", "Admin dashboard"]
  },
    {
      title: "Hospital Management System",
      description: "A comprehensive web-based system for managing hospital operations with role-based access control.",
      technologies: ["Python", "Django", "MySQL"],
      features: ["Role-based access", "Dynamic website", "Secure workflows"]
    },
    {
      title: "Online Learning Platform",
      description: "Scalable e-learning platform with course management and student enrollment capabilities.",
      technologies: ["Python", "Django", "MySQL"],
      features: ["Course creation", "Student enrollment", "Admin panel"]
    },
    {
title: "E-commerce Website (Python)",
    description: "A full-featured online shopping platform with product listing, cart, and secure user authentication.",
    technologies: ["Python", "Django", "MySQL", "HTML", "CSS", "JavaScript"],
    features: ["Customer login", "Product catalog", "Add to cart", "Quantity control", "Order management", "Admin panel"]
    },
    {
      title: "Online Food Ordering Website",
      description: "Dynamic food ordering platform with secure payment processing and restaurant management.",
      technologies: ["Django", "MySQL"],
      features: ["Menu browsing", "Secure payments", "Restaurant management"]
    }
  ];
      ...
      <section id="hero" className="pt-24 pb-20 px-6 relative">
        <div className="container mx-auto text-center relative z-10">
          <div className="animate-fade-in">
            <div className="w-32 h-32 mx-auto mb-8 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-full flex items-center justify-center text-4xl font-bold text-black animate-float border-2 border-cyan-400 shadow-lg shadow-cyan-500/50">
              RV
            </div>
          <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 bg-clip-text text-transparent animate-glow">
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto animate-slide-up">
              <GlitchText text="Full Stack Developer | Python, Django, Node.js, Express, MySQL, JavaScript | Web Application Specialist" />
            </p>
          ...
          <div className="max-w-4xl mx-auto">
            <Card className="border border-cyan-500/30 shadow-xl bg-black/50 backdrop-blur-sm animate-slide-up">
              ...
              <CardContent className="space-y-6">
               ...
               Full Stack Developer with hands-on experience in building and deploying scalable, high-performance web applications using Python, Django, Node.js, Express, MySQL, and modern frontend technologies. Proven expertise in end-to-end application development, including e-commerce platforms, hotel booking systems, and billing software.
                </p>
                <p className="text-lg text-gray-300 leading-relaxed">
                  Proficient in both frontend (HTML, CSS, JavaScript, Bootstrap) and backend development, with a strong grasp of RESTful API development, database architecture, and responsive UI/UX design. Experienced in developing secure, maintainable, and efficient solutions that align with business objectives and enhance user experience.
                </p>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <div className="animate-slide-left">
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <p className="text-gray-300">Siddhant Institute of Application, Pune</p>
                        <p className="text-sm text-gray-400">September 2024 (Pursuing)</p>
                      </div>
                      <div>
                        <h4 className="font-semibold text-white">Bachelor of Computer Application</h4>
                        <p className="text-gray-300">New Art's Commerce and Science College, Ahmednagar</p>
                  ...
                  <div className="animate-slide-right">
                    ...
                    <div className="space-y-2 text-gray-300">
                      ...
                      <p><strong className="text-cyan-400">Experience:</strong>1.6 Years & 6 Months Internship</p>
      ...
      <footer className="bg-black border-t border-cyan-500/30 text-white py-8 px-6 relative">
        <div className="container mx-auto text-center relative z-10">
          <p className="text-gray-400">
            © 2024 Ruturaj Dilip Vidhate. Crafted with passion and precision.
          </p>
        </div>
      </footer>
    </div>
